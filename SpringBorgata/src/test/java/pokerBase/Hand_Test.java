...
public class Hand_Test {
	...
	public void ThreeOfAKind_2() {
		...
		assertTrue(c2.getRank().getRank() == eRank.QUEEN.getRank());
	}		
	@Test
	public void ThreeOfAKind_3() {
		...
		//	Check to see if the first kicker is a ACE
		assertTrue(c1.getRank().getRank() == eRank.ACE.getRank());
	...
	public void CompareTwoHands() {
		Deck d = new Deck();
		Hand h1 = new Hand();
		h1.AddCardToHand(new Card(eSuit.CLUBS,eRank.TWO,0));
		...
		Hand h2 = new Hand();
		h2.AddCardToHand(new Card(eSuit.CLUBS,eRank.KING,0));
